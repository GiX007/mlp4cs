...
#SBATCH --output=logs/ft_qwen3_8b_%j.out
#SBATCH --error=logs/ft_qwen3_8b_%j.err
#SBATCH --account=EUHPC_D34_189

# Exp3: Fine-tune DST + ResponseGen LoRA adapters for Qwen3-8B
cd $WORK/mlp4cs
