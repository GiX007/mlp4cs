...
#SBATCH --output=logs/ft_llama31_8b_%j.out
#SBATCH --error=logs/ft_llama31_8b_%j.err
#SBATCH --account=EUHPC_D34_189

# Exp3: Fine-tune DST + ResponseGen LoRA adapters for LLaMA-3.1-8B
cd $WORK/mlp4cs
