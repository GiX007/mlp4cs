...
[9] Abdin et al., Phi-4 Technical Report (2024)
- Microsoft's Phi-4 14B model, trained on 9.8T tokens with a heavy emphasis on synthetic data curated for reasoning and instruction-following
- Covers the only non-LLaMA / non-Qwen open-source model in the project, used across all three experiments (Exp1, Exp2, Exp3)

[10] Hudecek & Dušek, "Are LLMs All You Need for TOD?" (2023)
...
[15] Baidya et al., The Behavior Gap (2025)
...
[16] Feng et al., DIMF / Empowering LLMs in TOD (2025)
...
[17] Kranti et al., clem:todd (2025)
...
[22] Deriu et al., Survey on Evaluation Methods for Dialogue Systems (2021)
...
[23] Nekvinda & Dušek, "Shades of BLEU, Flavors of Success", (2021)
